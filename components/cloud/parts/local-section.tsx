    ...
    <div className="c-card" style={{ maxWidth: '600px', width: '100%', padding: '32px' }}>
      <VStack spacing={6} align="stretch">
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <Text fontWeight="bold" color="var(--steel)">{t('local-backup-title')}</Text>
        </div>

        <Text color="var(--text2)" fontSize="sm">{t('local-backup-description')}</Text>
        ...
        <HStack spacing={4} width="100%">
          <Button
            ...
            height="44px"
            variant="outline"
            borderColor="rgba(74,104,136,0.4)"
            color="var(--text)"
            fontSize="14px"
            onClick={exportLocal}
            leftIcon={
            ...
            _hover={{ bg: 'rgba(74,104,136,0.1)', borderColor: 'rgba(74,104,136,0.6)' }}
          >
            {t('export-to-file')}
          </Button>
